...
# sa_fa = int(input(""))
    return grade, max_aggregate_size, slump, concrete_type, exposure_condition, concrete_placing, aggregate_type, max_cement_content, chemical_admixture, sg_chemical_admixture, percent_chemical_admixture, sg_cement, mineral_admixture, sg_mineral_admixture, percent_mineral_admixture, sg_ca, sg_fa, sg_water, sa_ca
